    ...
    <div className="w-full h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full lgl:w-1/2 h-full flex">
        ...
        <div className="hidden lgl:flex flex-col items-center justify-center bg-primeColor text-white w-1/2 p-10">
          ...
          <h1 className="text-2xl font-semibold mb-4">Welcome to Raction Ease</h1>
          <p className="text-lg mb-6">The Digital Ration Card System designed for Urban Slums.</p>
          <div className="flex flex-col gap-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-lg">
                ...
                <br />
                Simplify the process of ration distribution with a user-friendly digital platform.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <BsCheckCircleFill className="text-green-500" />
              <p className="text-lg">
                ...
                <br />
                Quickly access and manage your ration card information with ease.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <BsCheckCircleFill className="text-green-500" />
              <p className="text-lg">
                ...
                <br />
                Tailored to meet the needs of urban slum residents for better accessibility.
              </p>
            </div>
          </div>
          <div className="mt-10 flex justify-between text-sm">
            <Link to="/" className="hover:text-gray-300">© Raction Ease</Link>
        ...
        <div className="w-full lgl:w-1/2 flex items-center justify-center p-8">
          {successMsg ? (
            ...
            <form onSubmit={handleSignIn} className="w-full max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className={`w-full h-12 px-4 border rounded-md outline-none ${errEmail ? 'border-red-500' : 'border-gray-300'}`}
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className={`w-full h-12 px-4 border rounded-md outline-none ${errPassword ? 'border-red-500' : 'border-gray-300'}`}
